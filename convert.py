...
class Color:
	...
	def __init__(self, in_col):
		...
		assert (is_rgb(in_col) or is_hex(in_col) or in_col.lower() in self.colors.keys()), 'Error, the input color "%s" is not a valid rgb color, hex color or named color' % in_col
